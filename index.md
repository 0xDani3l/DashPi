...
Smart cars are cool, but I'm a college student that can barely afford fuel. I may be stuck with my dumb '07 Subaru Impreza, but that doesn't mean I can't try and make it smarter myself.  
...
Using this, we can easily connect to and read the device data with a simple python script.
